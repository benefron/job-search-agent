...
that were evaluated against Ben's profile (bypassing the LLM API).
...
# ---------------------------------------------------------------------------
# Ben's manually evaluated scores
# Format: id -> (score, fit_category, key_matches, key_gaps, rationale)
# ---------------------------------------------------------------------------
SCORES = {
    # ── TNO energy / environment ── (no description, unrelated domain)
    "90ccc189c858888f": (12, "poor", [], ["unrelated domain", "no description"], "Energy infrastructure is unrelated to neuromorphic/neuro/AI Ben's target domains."),
    "bc47c846086e74c8": (12, "poor", [], ["unrelated domain", "no description"], "Sustainable materials R&D at TNO is outside Ben's domain expertise."),
    "97aadb506e5756e1": (12, "poor", [], ["unrelated domain", "no description"], "Carbon-neutral industry focus does not overlap with Ben's profile."),
    ...
    "844d110cd3cd371f": (10, "poor", [], ["unrelated domain", "no description"], "Energy systems transition is outside Ben's expertise."),
    "881e8288fb50ff77": (10, "poor", [], ["unrelated domain", "no description"], "Offshore wind farms domain is not relevant to Ben."),
    "8bcaa9f33b5737f0": (10, "poor", [], ["unrelated domain", "no description"], "Solar device technology is outside Ben's domain."),
    "552c798812349dcb": (10, "poor", [], ["unrelated domain", "no description"], "Sustainable solar panels — unrelated to neuro/AI."),
    "6f29de79315c043c": (10, "poor", [], ["unrelated domain", "no description"], "Solar applications — not relevant to Ben's profile."),
    ...
    "0931f3c1f50e8b3f": (10, "poor", [], ["unrelated domain", "no description"], "Energy storage — not relevant to Ben's profile."),
    ...
    # ── Industry / Tech ──
    "e3b3dc73fc3a235b": (88, "strong", ["imec", "systems & algorithms", "AI architecture", "Eindhoven", "research institute"], ["seniority may be higher than postdoc"], "Senior AI Architect (Systems & Algorithms) at imec NL in Eindhoven — directly in Ben's current employer domain with perfect skill overlap in AI systems and algorithm design."),
    ...
    "ec11ce808e42be66": (72, "strong", ["sensing architecture", "hardware+algorithm", "Eindhoven", "sensor systems", "TMC"], ["consulting/contracting nature"], "Sensing Architect (hardware & algorithm) at TMC Eindhoven — excellent match: sensor system design + algorithm development, core of Ben's imec work."),
    ...
    "8b28fd4ffd65d745": (52, "moderate", ["Innatera neuromorphic chip company", "Netherlands"], ["program manager role not technical", "non-research position"], "Staff Program Manager at Innatera — Innatera is a neuromorphic chip startup directly in Ben's domain; PM role is a career shift but the company fit is exceptional."),
    ...
    "53089a4299ce0008": (15, "poor", [], ["retail domain", "no neuro/sensing"], "AI Engineer at Wehkamp Retail — retail recommender systems, not relevant to Ben's expertise."),
    ...
    "f127d5bb50bef642": (10, "poor", [], ["travel tech", "unrelated domain"], "ML Engineer at FareHarbor — travel/ticketing software, unrelated to Ben's domain."),
    ...
    "3afc19d6d58df4bc": (20, "poor", ["KNAW", "research institute"], ["research assistant underqualified for PhD holder", "generic support role"], "Research Assistant at KNAW — Ben is overqualified; generic research support role at a prestigious institute."),
    ...
    "c420d2fb2d3953fe": (42, "stretch", ["Donders Centre", "cognitive neuroscience", "Radboud", "Nijmegen"], ["research assistant level", "overqualified", "no description"], "Research Assistant at Donders Centre for Cognition Radboud — prestigious neuroscience institute; RA level is below Ben's qualification, but domain overlap is good."),
    ...
    "09233f800582562d": (10, "poor", [], ["mechanical engineering", "not Ben's domain"], "Mechanical Engineer at Monumental — not relevant to Ben's profile."),
    "48b2e121c0e19dcc": (5, "poor", [], ["QA testing", "software", "not research"], "QA/Test Engineer at Blinqx — software testing role, not research or engineering Ben's domain."),
    ...
    "c21d4ab631a003eb": (5, "poor", [], ["technical writer", "not research"], "Technical Writer at Nebius — documentation role, not a fit for Ben as researcher/engineer."),
