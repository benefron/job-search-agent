...
# ---------------------------------------------------------------------------
SEARCH_QUERIES = [
    # ── Belgium / Leuven (primary location) ─────────────────────────────────
    ...
    ("research scientist AI", "Leuven Belgium"),
    ("biomedical engineer", "Leuven Belgium"),
    ("data scientist", "Leuven Belgium"),
    ("machine learning engineer", "Leuven Belgium"),
    ("research engineer", "Leuven Belgium"),
    ("signal processing engineer", "Leuven Belgium"),
    # Brussels
    ("ML engineer", "Brussels Belgium"),
    ("research scientist", "Brussels Belgium"),
    ("data scientist neuroscience", "Brussels Belgium"),
    ("embedded AI", "Brussels Belgium"),
    ("biomedical AI", "Brussels Belgium"),
    ("neurotech", "Brussels Belgium"),
    # Liège (easy train commute)
    ("edge AI", "Liège Belgium"),
    ("research engineer AI", "Liège Belgium"),
    ("ML engineer", "Liège Belgium"),
    # Belgium broad (catches Ghent, Antwerp, and others)
    ("computational neuroscience", "Belgium"),
    ("neurotech", "Belgium"),
    ("neuromorphic", "Belgium"),
    ("data scientist biomedical", "Belgium"),
    ("data scientist neuroscience", "Belgium"),
    ("research scientist neuroscience", "Belgium"),
    # Ghent / Antwerp (lower priority — secondary commute)
    ("research engineer", "Ghent Belgium"),
    ("ML engineer", "Antwerp Belgium"),
    # Mechelen / Zaventem / Hasselt / Tervuren (acceptable commute from Leuven)
    ("research engineer", "Mechelen Belgium"),
    ("ML engineer", "Mechelen Belgium"),
    ("research scientist", "Zaventem Belgium"),
    ("embedded AI", "Zaventem Belgium"),
    ("research engineer", "Hasselt Belgium"),
    ("ML engineer", "Hasselt Belgium"),
    ("research scientist", "Tervuren Belgium"),
    ("ML engineer", "Tervuren Belgium"),
    # ── Netherlands (secondary — higher bar for fit) ──────────────────────
    ...
    ("data scientist neuroscience", "Netherlands"),
    ("data scientist biomedical", "Netherlands"),
    ("data scientist signal processing", "Netherlands"),
    ("embedded AI", "Eindhoven Netherlands"),
    ("ML engineer", "Breda Netherlands"),
    # Academic postdocs (NL)
...
_VISA_DENIAL = [
    ...
    "unable to sponsor work visa",
    "do not sponsor work visa",
    "does not sponsor visa",
    "must be authorized to work without sponsorship",
    "must have the right to work without sponsorship",
    "authorized to work in",
    "right to work in the",
    "no work permit support",
    "we do not provide visa",
...
def _should_exclude(title: str, description: str) -> str | None:
    ...
    # Visa denial — explicitly states no sponsorship available
    for pat in _VISA_DENIAL:
        if pat in d:
            return f"no visa support: {pat}"
