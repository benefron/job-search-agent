...
Automated daily job search tailored to Ben Efron's profile. Runs via GitHub Actions, scrapes LinkedIn/Indeed and target company career pages, scores matches using the GitHub Models API, and publishes results to a static dashboard on GitHub Pages.
...
│   ├── profile.py       # Ben's profile (used in scoring prompt)
